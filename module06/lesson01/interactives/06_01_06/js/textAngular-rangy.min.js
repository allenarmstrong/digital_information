    ...
    b["true"] = a, function (b, c) {
        ...
        H.addShimListener = function (a) {
            ...
            function F(b, d) {
                ...
                j.prototype = a.rangePrototype, b.prototype = new j, K.extend(b.prototype, {
                    ...
                    normalizeBoundaries: function () {
                        ...
                        if (N(e))f == e.length ? g(e) : 0 == f && (a = e.previousSibling, a && a.nodeType == e.nodeType && (f = a.length, b == e && (i = !1), a.appendData(e.data), Y(e), e = a)); else {
                            if (f > 0) {
                        ...
                        if (i) {
                            if (N(b))0 == c ? h(b) : c == b.length && (a = b.nextSibling, a && a.nodeType == b.nodeType && (e == a && (e = b, f += b.length), b.appendData(a.data), Y(a))); else if (c < b.childNodes.length) {
            ...
            K.extend(a.rangePrototype, {
                compareBoundaryPoints: function (a, b) {
                ...
                }, createContextualFragment: ia, toHtml: function () {
                    return B(this)
                    ...
                    for (var d, e, f, g, h = [b], i = !1, j = !1; !j && (d = h.pop());)if (3 == d.nodeType)e = c + d.length, !i && a.start >= c && a.start <= e && (this.setStart(d, a.start - c), i = !0), i && a.end >= c && a.end <= e && (this.setEnd(d, a.end - c), j = !0), c = e; else for (g = d.childNodes, f = g.length; f--;)h.push(g[f])
                }, getName: function () {
                    return "DomRange"
                }, equals: function (a) {
            ...
            function t(a, b) {
                for (var c, d, e = ba.length; e--;)if (c = ba[e], d = c.selection, "deleteAll" == b)s(d); else if (c.win == a)return "delete" == b ? (ba.splice(e, 1), !0) : d;
            ...
            if (Q)fa = function (b) {
                ...
                if (_ && P && b.docSelection.type == K)p(b); else if (b._ranges.length = b.rangeCount = b.nativeSelection.rangeCount, b.rangeCount) {
